...
// ---------------------------------------------------------------------------
// Semesters — per-user terms grouping courses/tasks. Until the semesters
// migration has run these actions return a friendly error, and the task/course
// actions silently skip semester attachment.
